      ...
      <div class="carousel-caption">
          ...
          <h3>
               @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=8" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
     ...
     <div class="carousel-caption">
          ...
          <h3>
              @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=6" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
     ...
     <div class="carousel-caption">
          ...
          <h3>
               @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=13" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
      ...
      <div class="carousel-caption">
          ...
          <h3>
               @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=14" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
      ...
      <div class="carousel-caption">
          ...
          <h3>
              @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=26" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
      ...
      <div class="carousel-caption">
          ...
          <h3>
               @if (!Session::has('sess_email'))  
                                <p><a href="/login" role="button" class="btn btn-primary bu1">Book Now</a></p> 
                             @else
                                    <a href="/book?id=22" name="add" value="add" class="btn btn-primary bu1">Book Now</a>
                            @endif  
